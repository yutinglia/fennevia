...
| --- | --- | --- | --- |
| `0.18.0-beta.1` | Stock Firefox 153.0.4, 154.0, and 154.0.1 release; Build IDs `20260810162159` / `20260812182057` / `20260824154132` | Windows x64 | Current public prerelease; later majors install only after an explicit no-promise warning |
