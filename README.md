...
| Package          | `fennevia-0.13.0-beta.1-windows.zip`                 |
...
edges, a tabbed customize drawer, optional compact windows, bounded appearance,
...
matrix is the `0.12.0-beta.1` candidate; this `0.13.0-beta.1` package does not
