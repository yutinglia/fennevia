...
As of 2026-08-23, Fennevia has a published Windows x64 prerelease,
`v0.12.0-beta.1`, tested on stock Firefox 153.0.4 release, Build ID
...
real-Firefox validation claim for `v0.12.0-beta.1`.
