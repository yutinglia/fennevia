...
**Open full Firefox address bar** reveal the complete native controls. Returning
focus to web content and closing native panels restores the content-only resting
view.
...
- A complete replacement for Firefox's Urlbar providers, Firefox View,
  ...
  extension actions.
- Custom titlebar or OS window controls in the current roadmap.
