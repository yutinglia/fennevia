...
| Fennevia customize mode (ADR-045, ADR-046, ADR-047, ADR-054, ADR-074–ADR-076) | Focused implementation; real-Firefox matrix pending                                                                            | Strict recursive four-edge widget trees, searchable/filterable CustomizableUI and project-feature palette, exact projected drops, bounded autoscroll, one session-wide obstacle-aware floating inspector, nested Row/Column orientation, compatible duplicates, independent optional panels, confirmed Clean all, closed per-instance Address/Tabs variants, bounded appearance/interaction prefs, and owner-approved adopt/restore writes; native customize mode remains available                                                                                                                                                                                                                                                                                                                  |
...
per-instance styles, and ADR-076's session-wide floating inspector have focused
