...
const ownedEnglishLabels = Object.freeze({
  ...
  "Firefox menu": "nav.firefoxMenu",
  Back: "nav.back",
  Bookmarks: "surface.bookmarks",
  Center: "widget.center",
  "Close window": "window.close",
  Column: "widget.column",
  "Customize Fennevia": "nav.customizeTitle",
  "Download status": "widget.downloadStatus",
  Extensions: "nav.extensions",
  Expanded: "widget.expanded",
  Forward: "nav.forward",
  Home: "nav.home",
  "Maximize or restore window": "window.maximize",
  "Minimize window": "window.minimize",
  "New tab": "tab.newTab",
  Padding: "widget.padding",
  "Private browsing": "widget.privateIndicator",
  "Reload or stop": "nav.reload",
  Row: "widget.row",
  Settings: "nav.settings",
  "Site trust": "widget.trust",
  Tabs: "widget.tabs",
