...
import {
  COMMANDS,
  NAVIGATION_TAB_EVENT_TYPES,
  OPEN_LOCATION_COMMAND_ID,
  OPEN_LOCATION_KEY_ID,
  SHELL_HEALTH_ATTRIBUTE,
  ADDRESS_POPUP_OPEN_REQUEST,
  ACCEPTED_ADDRESS_SUBMISSION,
  EMPTY_ADDRESS_SUBMISSION,
  LONG_ADDRESS_SUBMISSION,
  UNSAFE_ADDRESS_SUBMISSION,
  EXECUTABLE_SCHEME_PATTERN,
  HIDDEN_COMMITTED_LOCATIONS,
  ...
  isUrlbar,
  isIdentityHandler,
  isProtectionsHandler,
  isContentBlockingAllowList,
  isSelectedBrowserNavigationShape,
  isCurrentUri,
  evaluateNavigationCapabilities,
  createNavigationError,
  snapshotsEqual,
  isRelevantTabAttributeEvent,
} from "./support.ts";
import type {
  NativeRecord,
  NativeCommand,
  NativeUrlbar,
  NativeIdentityHandler,
  NativeProtectionsHandler,
